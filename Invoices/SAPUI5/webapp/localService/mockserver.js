            ...
            init: function(oOptionsParameters){
                ...
                return new Promise (function(fnResolve, fnReject){
                    ...
                    oManifestModel.attachRequestCompleted(function(){
                        ...
                        //configure mock server with the given options or a default delay of 0.5 s
                        MockServer.config({
                            autoRespond: true,
                        ...
                        var fnResponse = function (iErrorCode, sMessage, aRequest) {
                            aRequest.response = function(oXhr) {
                                oXhr.respond(iErrorCode, {"Content-Type" : "text/plane;charset=utf-8"}, sMessage);
                            };
                        };
